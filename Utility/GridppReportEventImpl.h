...
public:
	...
	void __stdcall OnControlCustomDraw(IGRControl* pSender, IGRGraphics *pGraphics, LONG x, LONG y, LONG width, LONG height)
	{
		ControlCustomDraw(pSender, pGraphics, x, y, width, height);
	}
...
private:
	...
	virtual void ControlCustomDraw(IGRControl* pSender, IGRGraphics *pGraphics, LONG x, LONG y, LONG width, LONG height){};
